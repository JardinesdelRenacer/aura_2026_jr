                ...
                {isVertical ? (
                    ...
                    <div className="h-full w-full bg-linear-to-br from-white/60 via-blue-50/50 to-white/40 p-1.5 backdrop-blur-2xl sm:p-2">
                        <div className="grid h-full w-full grid-cols-3 grid-rows-2 gap-1.5 sm:gap-2">
                            ...
                            <div className="relative col-span-2 col-start-2 row-start-1 h-full min-h-0 w-full min-w-0 overflow-hidden rounded-xl border border-white/80 bg-[url('/imagenes/35.png')] bg-cover bg-center shadow-xl sm:rounded-2xl">
                            ...
                            {roomsToShow
                                ...
                                .map(({ roomKey, ob, isActive }, index) => {
                                    ...
                                    return (
                                        <div key={roomKey} className={`${slotClasses[index]} relative flex h-full min-h-0 w-full min-w-0 flex-col items-center justify-start overflow-hidden rounded-lg border border-white/30 bg-[url('/imagenes/35.png')] bg-size-[100%_100%] bg-no-repeat text-center shadow-lg sm:rounded-xl`}>
