...
export default function ObituarioVertical({ obituary, formatDate, formatTime }: Props) {
    ...
    return (
        <div className="relative flex h-full w-full flex-col items-center justify-start overflow-hidden rounded-[1.6rem] bg-[url('/imagenes/fondo_obituarios.png')] bg-size-[100%_100%] bg-no-repeat p-5 text-center text-black sm:p-8">
