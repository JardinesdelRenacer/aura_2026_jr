...
import CondolenciasReportes from "./CondolenciasReportPanel";
import CondolenciasReportPanel from "./CondolenciasReportPanel";
...
export function ReportesTab({ branches }: ReportesTabProps) {
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            {/* Condolencias */}
            <CondolenciasReportPanel branches={branches}  />
